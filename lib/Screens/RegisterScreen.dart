...
class _RegisterScreenState extends State<RegisterScreen> {
  String state = "type";
  final TextEditingController _nameTextEditingConroller =
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  if (_nameTextEditingConroller.text.isEmpty ||
                                      _nameTextEditingConroller.text.length < 3)
                                    Fluttertoast.showToast(
                                        msg:
                                            "الاسم لا يمكن ان يكون فارغاً ويجب ان يحتوي على 3 احرف على الاقل");
                                  else if (_emailTextEditingConroller
                                          .text.isEmpty ||
                                    ...
                                    AuthService()
                                        .reigester(
                                            ...
                                            _passwordTextEditingConroller.text
                                                .trim(),
                                            _nameTextEditingConroller.text
                                                .trim())
                                        .then((va) async {
                                      FirebaseFirestore.instance
                                        ...
                                        "name": _nameTextEditingConroller.text
                                            .trim(),
                                        "email": _emailTextEditingConroller.text
                                            .trim(),
                                      });
                                      var uu = await FirebaseFirestore.instance
                                          .collection('Users')
                                          .doc(va.user!.uid)
                                          .get();
                                      ...
                                      sharedPrefs.name =
                                          _nameTextEditingConroller.text.trim();
                                      sharedPrefs.email =
                                          _emailTextEditingConroller.text
                                              .trim();
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  if (_nameTextEditingConroller.text.isEmpty ||
                                      _nameTextEditingConroller.text.length <
                                          3) {
                                    Fluttertoast.showToast(
                                        msg:
                                            "الاسم لا يمكن ان يكون فارغاً ويجب ان يحتوي على 3 احرف على الاقل");
